...
/* 4 bit LED Digital Tube 모듈로 타이머 제어를 위한 헤더 */
/* 출처: https://github.com/magiccow/_7seg-display-simple/blob/master/_7seg-display-simple.ino */ 


//Pins on the 74HC595 shift reg chip - correspondence with Arduino digital pins
unsigned int ST_CP = A1;     // RCLK
unsigned int SH_CP = A2;     // SCLK
unsigned int DS    = A0;     // DIO
